...
from apps.doctores.views import CreateMedico, UpdateMedico, ListMedico, DeleteMedico, CreateDiagnostico, DeleteDiagnostico, UpdateDiagnostico, ListDiagnostico
from apps.doctores.views import CreateHistoriaClinica, DeleteHistoriaClinica, UpdateHistoriaClinica, ListHistoriaClinica
